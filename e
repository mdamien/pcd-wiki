{{Taxoboète début | animal | É| European honey bee extracts nectar.jpg | }}
{{Taxoboète | embranchement | Arthropoda  }}
{{Taxoboète | classe | Insecta  }}
{{Taxoboète | ordre | Hymenoptera }}
{{Taxoboète | sous-ordre | Apocrita }}
{{Taxobox | super-famille | Apoidea  }}
{{Taxoboète | famille | Apidae   }}
{{Taxoboète | sous-famille | Apinae   }}
{{Taxoboète | tribu | Apini       }}
{{Taxoboète | genre | Apis (genre)|Apis }}
{{Taxoboète taxon | animal | espèce | Apis mellifera| [[Carl von Linné|Linnaeus]], [[1758]]  }}
{{Taxoboète wikispecies | Apis mellifera}}
...
*'''Italhyin·ne'''<ref>Variantes: ''italienne''</ref> (in frinsé: ''abeille de race italienne'') 
